...
import { USERS, VERSIONS } from '@/lib/data';
...
export default function VersionsScreen() {
  ...
  return (
    <div className="page" style={{ paddingTop: 22 }}>
      <button onClick={() => router.push('/documents/d1')} className="btn ghost sm" style={{ marginBottom: 12, color: 'var(--ink-3)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: 18 }}>
        <div className="card" style={{ padding: '6px 0' }}>
          {VERSIONS.map((v, i) => {
            ...
            return (
              <motion.div key={v.v} onClick={() => setSelected(v.v)}
