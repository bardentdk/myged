...
import { USERS, ME, DOCS, VERSIONS } from '../data.js';
...
const DocumentScreen = ({ docId, onNavigate, onShowToast, scenario, onScenarioChange }) => {
  ...
  const handleDownloadCopy = () => { onShowToast({ message: `Copie téléchargée — ${doc.name}`, icon: 'download' }); };
...
const ReleasedBanner = ({ onEdit }) => (
  <div className="card" style={{ borderColor: '#9fd3b5', background: 'linear-gradient(180deg, #f1faf3, #e7f6ec)' }}>
