...
import { Avatar, FileIcon } from '../atoms.jsx';
import { ME } from '../data.js';

const AiPanel = ({ onClose, onShowToast }) => {
          ...
          {typing && (
            <div className="row" style={{ gap: 10 }}>
              ...
              <div className="row" style={{ gap: 4, padding: '8px 12px', background: 'var(--surface-2)', borderRadius: 12 }}>
                {[0, 1, 2].map(i => (
                  <span key={i} style={{ width: 5, height: 5, borderRadius: 999, background: 'var(--ink-3)', animation: `bounce 1.2s ${i * .15}s infinite` }} />
                ))}
