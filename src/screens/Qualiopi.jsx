...
import { Avatar, Badge, FileIcon } from '../atoms.jsx';
import { USERS, QUALIOPI } from '../data.js';
              ...
              {QUALIOPI.map(q => {
                ...
                return (
                  <tr key={q.num} onClick={() => setSelected(q.num)} style={{ background: selected === q.num ? 'var(--surface-2)' : 'transparent' }}>
                    ...
                    <td><Badge kind={statusMap[q.status]} dot>{labels[q.status]}</Badge></td>
