        ...
        <div>
          <div className="card" style={{ padding: '10px 14px', marginBottom: 14, display: 'flex', gap: 10 }}>
            <div className="search" style={{ flex: 1 }}>
              ...
              <input placeholder="Nom, e-mail, rôle…" value={search} onChange={e => setSearch(e.target.value)} style={{ flex: 1 }} />
            </div>
              ...
              <tbody>
                {shown.map(u => (
                  <tr key={u.id}>
                    ...
                    <td>
                      <Badge kind="neutral">{u.role}</Badge>
                    </td>
        ...
        <div className="modal-bg" onClick={() => setShowInvite(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ padding: '14px 24px', borderTop: '1px solid var(--line)', display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
              ...
              <button className="btn primary" onClick={() => { setShowInvite(false); onShowToast({ message: 'Invitation envoyée avec succès', icon: 'send' }); }}>
