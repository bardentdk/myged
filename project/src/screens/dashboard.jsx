// Dashboard — KPIs, activity, alerts, qualiopi snapshot, locked docs
              ...
              {[
                ...
                <div key={i} style={{ padding: '12px 18px', borderTop: i > 0 ? '1px solid var(--line)' : 0, display: 'flex', gap: 12, alignItems: 'flex-start', cursor: 'pointer' }}>
                  <div style={{
                    ...
                    background: t.accent ? 'var(--accent-soft)' : 'var(--surface-2)',
                    color: t.accent ? 'var(--accent)' : 'var(--ink-2)',
