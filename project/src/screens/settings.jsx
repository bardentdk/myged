// Settings — security, integrations, backup
const SettingsScreen = ({ onShowToast }) => {
  const [tab, setTab] = useState('security');
  const [saved, setSaved] = useState(false);
  const save = () => { setSaved(true); onShowToast({ message: 'Paramètres enregistrés', icon: 'check' }); setTimeout(() => setSaved(false), 1800); };
  ...
  <div className="card">
    ...
    <div style={{ padding: '0 22px' }}>
      ...
      <SettingRow label="Durée de session" sub="Déconnexion automatique après inactivité">
        <select className="input" style={{ width: 160, height: 34, fontSize: 13, padding: '0 10px' }}>
  ...
  <div className="card">
    ...
    <div style={{ padding: '0 22px' }}>
      ...
      <SettingRow label="N° de déclaration d'activité">
        <input className="input" defaultValue="974-OF-001234" style={{ width: 200 }} className="input mono" />
      </SettingRow>
...
const StorageTab = () => (
  <div className="col" style={{ gap: 18 }}>
    ...
    <div className="card">
      ...
      <div style={{ padding: '0 22px' }}>
        <SettingRow label="Fréquence des sauvegardes"><select className="input" style={{ width: 160, height: 34, fontSize: 13, padding: '0 10px' }}><option selected>Quotidienne</option><option>Hebdomadaire</option></select></SettingRow>
        <SettingRow label="Rétention" sub="Durée de conservation des sauvegardes"><select className="input" style={{ width: 160, height: 34, fontSize: 13, padding: '0 10px' }}><option>30 jours</option><option selected>90 jours</option><option>1 an</option></select></SettingRow>
        <SettingRow label="Dernière sauvegarde" sub="Sauvegarde complète réussie"><span className="mono" style={{ fontSize: 13, color: 'var(--ok)' }}>15 mars 2026 · 03:00</span></SettingRow>
      </div>
